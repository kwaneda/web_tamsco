          ...
          <div className="flex flex-col md:flex-row items-center gap-8">
            ...
            <div className="w-full md:w-1/2">
              ...
              <p className="text-[#333333] mb-6 leading-relaxed">
                탐스 경영컨설팅은 기업의 지속 가능한 성장과 자산가의 안정적인 승계를 지원하기 위해
                설립된 세무 및 경영 전문 컨설팅 기업입니다.
                자산과 경영 전반에 걸친 세무 전략의 중심축을 다루며
                세무,회계, 법무, 부동산 등 각 분야의 전문가들이 협업하여 정밀한 분석과 실행 중심의 전략으로
                고객의 세무 리스크를 최소화하고 자산 가치를 극대화 합니다.

                세무 이슈 해결은 물론, 지속 가능한 경영과 자산 보호까지.
                단순한 자문을 넘어 고객과 함께 성장하는 동반자적 컨설팅을 제공하는
