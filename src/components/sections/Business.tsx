...
const Business = () => {
  ...
  const detailedServices = [
    ...
    {
      title: "가업승계 컨설팅",
      items: ["상속ㆍ증여 플랜", "가업상속공제 플랜", "물업보험, 특정보험설립"],
    },
    {
      title: "법인전환 컨설팅",
      items: [
    ...
    {
      title: "M&A, IPO컨설팅",
      items: ["M&A 컨설팅", "M&A 중개, IPO 중개", "법인 밸류업 전략 컨설팅"],
    },
    {
      title: "가치금융 컨설팅",
      items: [
    ...
    {
      title: "경영정구 컨설팅",
      items: ["예상흐름액 진단•분석", "사업자 경영정구 전략"],
    },
    {
      title: "직원로열티 컨설팅",
      items: ["스톡옵션제도", "우리사주조합", "성과급제제도"],
    },
    {
      title: "MSO 설립",
      items: ["명의변환설립", "간접법인설립"],
    ...
    {
      title: "기업연구소설립",
      items: ["기업연구소/전담부서 설립", "연구소 시후관리"],
    },
    {
      title: "벤처인증, 각종인증",
      items: ["벤처인증, ISO인증", "이노비즈, 메인비즈 인증"],
    },
    {
      title: "투자유치 컨설팅",
      items: ["사업계획서 코칭", "VC, 개인투자조합 연결"],
    },
    {
      title: "기타 전문가 상담",
      items: ["기업분쟁/노무분쟁", "세금신고, 세무조사 대응"],
    },
  ];
      ...
      <div className="container mx-auto px-4">
        ...
        <div className="text-center mb-12">
          <p className="text-lg text-[#333333] mb-4">
            경영 자문은 기업의 성황과 약점을 파악하여 효과적인 비즈니스 모델을
            제안하고, 문제를 해결하기 위한 적적의 솔루션을 찾아내고 기업 발전을
            도약합니다.
          </p>
          <p className="text-lg text-[#333333]">
            또한 자신기를 위한 계수 운영 및 부동산 담보등 다양한 영역에서
